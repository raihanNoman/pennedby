...
import { useDeleteAccount } from "@/utils/actions/delete-account";
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: bgColor }]} edges={["top"]}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerSubtitle}>Customize your digital ink & presence</Text>
                </View>

                <Section>
                    <Section.Title>Tools & Aesthetics</Section.Title>
                    {/* <SettingItem icon="feather" label="Ink Thickness & Style" onPress={() => {}} /> */}
                    <SettingItem icon="moon" label="Interface Theme" rightElement={<ThemeSelector />} />
                ...
                <Section>
                    ...
                    <SettingItem
                        icon={<MaterialCommunityIcons name="ethereum" size={20} color={tint} />}
                        label="Solana Wallet"
                    ...
                    <SettingItem
                        ...
                        onPress={() => router.push({ pathname: "/" })} // signatures
                    />
                    <SettingItem
                        icon="award"
                        label="Certification Tiers"
                        onPress={() => router.push({ pathname: "/pricing" })}
                    />
                </Section>
                ...
                <Section>
                    ...
                    />
                    <SettingItem icon="file-text" label="Terms of Service" onPress={() => {}} />
                    <SettingItem
                        icon="external-link"
                        label="pennedby.me"
                        onPress={() => Linking.openURL("https://pennedby.me")}
                ...
                {isLoggedIn ? (
                    <Section>
                        ...
                        <SettingItem icon="log-out" label="Sign Out" onPress={handleSignOut} />
                        <SettingItem
                            icon="trash-2"
                            label="Delete Account & Data"
                            destructive
                            loading={deleteAccount.loading}
                            onPress={deleteAccount.onDeletePressed}
                        />
                    </Section>
                ) : (
                    <Section>
                        <Section.Title>Security</Section.Title>
                        <SettingItem icon="log-in" label="Sign In" onPress={() => router.push({ pathname: "/auth" })} />
                    </Section>
                )}
                {/* 
