...
import { NewPostBtn } from "@/components/nav/NewPostBtn";
...
export default function HomePage() {
    ...
    const { tintColor, textColor, subText } = useColors();
        ...
        touch into a cinematic experience."
                ...
                <View style={[styles.manifesto, { borderTopColor: tintColor + "33" }]}>
                    <Text style={[styles.manifestoText, { color: textColor }]}>
                        ...
                        <Text style={{ color: tintColor, fontStyle: "italic" }}>meaning.</Text>”
                    </Text>
                </View>

                {/* Call to Action Area */}
                <View style={styles.ctaSection}>
                    <Text style={[styles.ctaHint, { color: subText }]}>Ready to leave your mark?</Text>
                </View>
...
function useColors() {
    ...
    return { tintColor, textColor, subText };
}
...
const styles = StyleSheet.create({
    ...
    callToAction: { width: "100%", maxWidth: SAFE_SCREEN_WIDTH, marginBottom: 24 },
    scrollContent: {
        paddingBottom: 100,
        alignItems: "center",
    },
