    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          How should this message exist in the world?
        </Text>
      </View>
          ...
          {["1", "10", "unlimited"].map((val) => (
            <Pressable
              ...
              style={[
                styles.chip,
                { borderColor: tint },
                viewLimit === val && { backgroundColor: tint },
              ]}
            >
              <Text
                style={[
                  styles.chipText,
                  { color: viewLimit === val ? bgColor : textColor },
                ]}
              >
                {val === "unlimited"
                  ? "Forever"
      ...
      <Pressable
        ...
        style={[styles.continueBtn, { backgroundColor: textColor }]}
      >
        <Text style={[styles.continueBtnText, { color: bgColor }]}>
          Review Draft
        </Text>
