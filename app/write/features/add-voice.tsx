    ...
    <View style={[styles.container, { backgroundColor: bgColor }]}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Your voice adds a soul to the stroke. Describe the philosophy behind
          this piece.
        </Text>
      </View>
      ...
      <View style={styles.recordContainer}>
        ...
        >
          <Feather
            name={recorder.isRecording ? "mic" : "mic"}
            size={34}
            color={bgColor}
          />
        </Pressable>
        ...
        <Text
          style={[
            styles.timer,
            { color: textColor, opacity: recorder.isRecording ? 1 : 0.3 },
          ]}
        >
          {recorder.isRecording
            ? formatTime(recorder.currentTime)
            : "Hold to Record"}
        </Text>
      </View>
