...
export default function NewWriting() {
    ...
    const bgColor = useThemeColor({ light: "#FDFCF8", dark: "#0b0b0b" }, "background");
    ...
    return (
        <View style={[styles.container, { backgroundColor: bgColor }]}>
            ...
            <MotiView
                ...
                style={styles.header}
            >
                <Text style={[styles.label, { color: textColor, opacity: 0.5 }]}>STEP 1: SELECT INTENT</Text>
                <Text style={[styles.title, { color: textColor }]}>Choose your canvas.</Text>
            </MotiView>
            ...
            <MotiView from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 600 }} style={styles.footer}>
                <Feather name="chevron-right" size={16} color={textColor} style={{ opacity: 0.3 }} />
                <Text style={[styles.footerHint, { color: textColor }]}>Swipe to explore moods</Text>
            </MotiView>
        </View>
    );
}
            ...
            >
                ...
                >
                    <View style={styles.cardHeader}>
                        ...
                        <View style={[styles.activeIndicator, { backgroundColor: contentColor }]} />
                    </View>

                    <View>
                        <Text style={[styles.cardTitle, { color: contentColor }]}>{mode.title}</Text>
                        <Text style={[styles.cardSubtitle, { color: contentColor, opacity: 0.8 }]}>
                            {mode.subtitle}
                        </Text>
                    </View>
                </LinearGradient>
